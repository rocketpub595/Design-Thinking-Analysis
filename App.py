...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='2144',db='cv')
...
def run():
    ...
    img = Image.open('./Logo/Landing Page.png')
    st.image(img)
    st.sidebar.markdown("# Choose Something...")
    activities = ["User", "Feedback", "About", "Admin"]
    choice = st.sidebar.selectbox("Choose among the given options:", activities)
    link = '<b>Built with 🤍 by <a href="https://dnoobnerd.netlify.app/" style="text-decoration: none; color: #021659;">Swaraj Kazi , Saket Mathur & Hitesh Bhattacharjee</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by 
            <a href="#" style="text-decoration: none; color: grey;">Swaraj Kazi , Saket Mathur & Hitesh Bhattacharjee</a>
            <a href="https://www.linkedin.com/in/saketmathur04/" style="text-decoration: none; color: grey;"></a>
        </p>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            ## Credentials 
            if ad_user == 'admin' and ad_password == 'DTI':
                ...
                st.success("Welcome SAKET ! Total %d " % values + " User's Have Used Our Tool : )")                
